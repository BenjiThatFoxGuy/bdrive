          ...
          {isDragging && !isDisabled && (
            <motion.div
              ...
              className={clsx(
                ...
                "bg-accent/10 backdrop-blur-[2px] pointer-events-none",
              )}
            >
              <motion.div
              ...
              >
                  <div className="size-16 rounded-2xl bg-accent-soft flex items-center justify-center text-accent-soft-foreground mb-2">
