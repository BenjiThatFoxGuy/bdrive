    ...
    return (
      <div
        className={clsx(
          ...
          status === FileUploadStatus.CANCELLED && "text-muted/50",
    ...
    >
      ...
      {effectiveShowCancel && onCancel && (
        <Button
          ...
          variant="ghost"
          onPress={onCancel}
          className="text-accent transition-all duration-200 size-6 min-w-6 absolute inset-0 [&>svg]:size-4 opacity-0 group-hover:opacity-100 bg-surface-secondary/80 backdrop-blur-sm rounded-full"
